...
public class HDFSUtils {
    ...
    private static String DEFAULT_URI = "hdfs://192.168.1.118:9000";
    ...
    public static boolean uploadLocalFile2HDFS(String localFile, String hdfsFile) throws IOException {
        ...
        hdfsFile = DEFAULT_URI + hdfsFile;
        Configuration config = new Configuration();
        FileSystem hdfs = FileSystem.get(URI.create(DEFAULT_URI), config);
