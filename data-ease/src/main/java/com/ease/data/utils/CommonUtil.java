...
public class CommonUtil {
     ...
     * @return
     */
    public static JSONObject errorJson(ResponseCodeEnum errorEnum) {
        JSONObject resultJson = new JSONObject();
        resultJson.put("returnCode", errorEnum.getCode());
        resultJson.put("returnMsg", errorEnum.getName());
    ...
    public static JSONObject successJson(JSONObject returnData) {
        return JSON.parseObject(ResultGenerator.createSucResult(returnData).toString());
    }
    public static JSONObject successJson() {
        return JSON.parseObject(ResultGenerator.createSucResult().toString());
    }
