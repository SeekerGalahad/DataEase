...
import com.ease.data.config.aop.vo.DurationVo;
import com.ease.data.config.aop.vo.HttpLogVo;
import com.ease.data.config.exception.RestException;
...
public class AspectLog {
    ...
    public void doAfterReturning(Object object) throws UnsupportedEncodingException {
        ...
        if (!(object instanceof RestResult || object instanceof PageUtil)) {
