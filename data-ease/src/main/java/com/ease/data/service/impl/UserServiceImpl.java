...
import com.ease.data.dao.UserDao;
import com.ease.data.service.UserService;
import com.ease.data.utils.CommonUtil;
...
public class UserServiceImpl implements UserService {
    ...
    public JSONObject addUser(JSONObject jsonObject) {
        ...
        if (exist > 0) {
            return CommonUtil.errorJson(ResponseCodeEnum.USER_EXIST);
        }
